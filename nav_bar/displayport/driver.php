...
<body>
    ...
    <main>
        ...
        <div class="wrapper">
            <div class="api-function">
                <div class="function-name">
                    <p>prt_dprx_dpcd_blk_set</p>
                </div> 

                <div class="function-section">
                    <div class="function-syntax">
                        <p>description: The function sets the address of the DPCD block. There are in total 16 blocks</p>
                        <p>syntax: uint8_t prt_dprx_dpcd_blk_set (prt_dp_ds_struct *dp, uint8_t idx, unit32_t adr);</p>
                        <p>parameters:</p>
                        <p>dp - pointer to DP peripheral</p>
                        <p>idx - index (0 - 15)</p>
                        <p>adr - DPCD base address</p>
                        <p>dat - pointer to DPCD data</p>
                        <p>returns:</p>
                        <p>Returns true when successful, else false.</p>
                    </div>
        ...
        <div class="wrapper">
            <div class="api-function">
                <div class="function-name">
                    <p>prt_dprx_dpcd_ack</p>
                </div> 

                <div class="function-section">
                    <div class="function-syntax">
                        <p>description: The function replies with an acknowledge after the DPCD callback is called</p>
                        <p>syntax: void prt_dprx_dpcd_ack (prt_dp_ds_struct *dp);</p>
                        <p>parameters:</p>
                        <p>dp - pointer to DP peripheral</p>
                        <p>returns:</p>
                        <p>none</p>
        ...
        <div class="wrapper">
            <div class="api-function">
                ...
                <div class="function-section">
                    <div class="function-syntax">
                        <p>description: The function replies with a not acknowledge after the DPCD callback is called</p>
                        <p>syntax: void prt_dprx_dpcd_ack (prt_dp_ds_struct *dp);</p>
                        <p>parameters:</p>
                        <p>dp - pointer to DP peripheral</p>
                        <p>returns:</p>
        ...
        <div class="wrapper">
            <div class="callbacks-section">
                <h3>Callbacks</h3>
                <p>The callback functions are used by the driver to signal the application about an event.</p>
                <p>functions are registered using the prt_dp_set_cb function.</p>
                <p>The diagram show the DP states and the callbacks.</p>
                <div class="callbacks-img">
                    <img src="../../img/dp_callbacks.svg" alt="img" height="1200" width="1100">
                    <p>Figure 1: DP callbacks</p>
                </div>
            </div>
        </div>
    </main>
    <footer>
        <div class="wrapper">
            <div class="api-function">
                ...
                <div class="function-section">
                    <div class="function-syntax">
                        <p>description: The function is called when a DPTX HPD event occured.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="wrapper">
            <div class="api-function">
                ...
                <div class="function-section">
                    <div class="function-syntax">
                        <p>description: The function is called during the link training and can be used to reset the PHY.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="wrapper">
            <div class="api-function">
                ...
                <div class="function-section">
                    <div class="function-syntax">
                        <p>description: The function is called when the policy maker is requesting a new line rate</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="wrapper">
            <div class="api-function">
                ...
                <div class="function-section">
                    <div class="function-syntax">
                        <p>description: The function is called when the policy maker is requesting to update the voltage swing and preamble levels.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="wrapper">
            <div class="api-function">
                ...
                <div class="function-section">
                    <div class="function-syntax">
                        <p>description: The function is called when the training status is updated.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="wrapper">
            <div class="api-function">
                ...
                <div class="function-section">
                    <div class="function-syntax">
                        <p>description: The function is called when the link status is updated.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="wrapper">
            <div class="api-function">
                ...
                <div class="function-section">
                    <div class="function-syntax">
                        <p>description: The function is called when the video stream status is updated.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="wrapper">
            <div class="api-function">
                ...
                <div class="function-section">
                    <div class="function-syntax">
                        <p>description: The function is called when the DPRX received updated main stream attributes.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="wrapper">
            <div class="api-function">
                ...
                <div class="function-section">
                    <div class="function-syntax">
                        <p>description: The function is called when the DPRX received a DPCD command.</p>
                    </div>
                </div>
            </div>
        </div>
